...
function sitemapEntry(url, localized) {
  const alternates = localized ? `<xhtml:link rel="alternate" hreflang="en" href="${url}"/><xhtml:link rel="alternate" hreflang="en-NZ" href="${url}"/><xhtml:link rel="alternate" hreflang="x-default" href="${url}"/>` : '';
...
const urls = [
  sitemapEntry(`${base}/`, true),
  sitemapEntry(`${base}/shop/`, true),
  sitemapEntry(`${base}/mtg/`, true),
  sitemapEntry(`${base}/trust-engine.html`, false),
  ...products.map(p => sitemapEntry(`${base}/products/${slug(p.id)}/`, true))
];
