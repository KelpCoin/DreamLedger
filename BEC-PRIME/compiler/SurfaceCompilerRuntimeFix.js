...
const markerToken = '[TEMPLATE,MANIFEST,OFFERS,IP,PRODUCTS,NEWS,AUCTIONS,CINEMA_TEMPLATE,DIGITAL_TEMPLATE].forEach(must);';
const start = source.indexOf(startToken);
const marker = source.indexOf(markerToken, start + startToken.length);
...
const closeStart = source.lastIndexOf('`}', marker);
