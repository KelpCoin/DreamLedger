...
function run() {
  ...
  const proof = { schema:'bec/kelplantis-mvp-compiler-proof/v4', status:'PASS', base_universal_compile:base.status, target:'kelplantis-mvp', target_type:'game', runtime:'HTML5/browser, Windows-hostable', native_windows_exe:false, slice:'DEPTH_1_SOCIAL', acceptance:{ create_avatar:'SOURCE_PRESENT', fountain_spawn:'SOURCE_PRESENT', movement:'SOURCE_PRESENT', player_presence:'SOURCE_PRESENT', inspection:'SOURCE_PRESENT', proximity_chat:'SOURCE_PRESENT', emotes:'SOURCE_PRESENT', persistence:'SOURCE_PRESENT', launch:'GENERATED_NOT_RUNTIME_VERIFIED', two_client:'NOT_RUNTIME_VERIFIED' }, outputs:files, runtime_verification:'NOT_EXECUTED' };
