...
async function proofForResult(input) {
...
if (typeof window !== 'undefined') window.KELPLANTIS_RESULT = { canonicalResult, proofForResult, buildShareCardSvg };
if (typeof module !== 'undefined') module.exports = { canonicalResult, proofForResult, buildShareCardSvg };
