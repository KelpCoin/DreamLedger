...
buildAccountPages();
for(const page of ['login.html','register.html','account.html']){const html=fs.readFileSync(path.join(OUT,page),'utf8');if(!html.includes('/api/account/'))throw new Error(`PRIMARY_ACCOUNT_SURFACE_FAILED: ${page}`);assertClean(page,html);}
