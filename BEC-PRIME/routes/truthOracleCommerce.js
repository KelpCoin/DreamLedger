  ...
  if(req.method==='POST'&&url==='/api/truth-oracle/checkout') {
    ...
    try {
      const session=await stripePost('checkout/sessions',{
        ...
        'payment_intent_data[metadata][product_sku]':'truth-oracle-'+plan.tier,
        'payment_intent_data[metadata][product_id]':'truth-oracle',
        'payment_intent_data[metadata][offer_id]':plan.tier,
        'payment_intent_data[metadata][silo]':'truth-oracle',
        'payment_intent_data[metadata][source]':'truth_oracle_checkout',
