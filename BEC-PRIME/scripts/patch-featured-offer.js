...
console.log(JSON.stringify({status:'PASS', featured_offer_id:offer.offer_id, product_id:offer.product_id, price_nzd:Number(offer.price), dreamledger_approved_count:dreamLedgerOffers.length, total_approved_count:offers.length, compiled_index:INDEX}, null, 2));
