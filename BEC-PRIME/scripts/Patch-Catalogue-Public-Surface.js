...
const proof={status:'PASS',mode:'SYNC_CANONICAL_COMPILE_TO_DEPLOYED_SURFACE',file:INDEX,deployed_file:DEPLOYED,sha256:crypto.createHash('sha256').update(html,'utf8').digest('hex'),required_present:[...required,'DreamMee control'],forbidden_absent:forbidden,agent_discovery_published:true,agent_discovery_sha256:crypto.createHash('sha256').update(discoveryText,'utf8').digest('hex'),ucp_published:true,truth_oracle_surface_required:'truth-oracle.html and truth-oracle.json are checked by verify-public-surface',generated_at:new Date().toISOString()};
