...
const required=['DreamLedger','Billboard','DreamMeez'];
...
const proof={status:'PASS',mode:'SYNC_CANONICAL_COMPILE_TO_DEPLOYED_SURFACE',file:INDEX,deployed_file:DEPLOYED,sha256:crypto.createHash('sha256').update(html,'utf8').digest('hex'),required_present:required,forbidden_absent:forbidden,truth_oracle_surface_required:'truth-oracle.html and truth-oracle.json are checked by verify-public-surface',generated_at:new Date().toISOString()};
