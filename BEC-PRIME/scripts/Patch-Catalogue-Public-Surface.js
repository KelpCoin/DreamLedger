...
if(missing.length)throw new Error('DIVERSIFIED PUBLIC SURFACE FAILED: missing '+missing.join(', '));
if(leaked.length)throw new Error('DIVERSIFIED PUBLIC SURFACE FAILED: forbidden '+leaked.join(', '));
