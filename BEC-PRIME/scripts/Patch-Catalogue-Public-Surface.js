...
const required=['DREAMLEDGER','Find something','Pick your next thing.','DreamMee','Billboard','MTG','NZ$50'];
const forbidden=['BUY THE OUTPUT.','FOR REAL.','Amplissa','HappyHomarid','CollectorsCoast','adult-only','adult only','stripe_secret_key','stripe_webhook_secret','/var/data/'];
