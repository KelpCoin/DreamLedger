...
$proof = [ordered]@{
    ...
    approved=[int]$offers.counts.approved
    rejected=[int]$offers.counts.rejected
    generated_offers=$generatedCount
    explicitly_approved_offers=$approvedCount
    generated_offers_require_approval=$true
    generated_offers_checkout_disabled=$true
    approved_offers_require_explicit_record=$true
    approved_offers_checkout_enabled=$true
