...
// and silo leakage. Published product and IP vocabulary is allowed on intentionally
// public surfaces and is not itself a secret.
const forbidden=[
  ...
  /KelpCoin/i,/Collector.?s Curse/i,/amplissa/i,/\bBBW\b/i,/big beautiful women/i
];
const errors=[];
