...
Write-Host "LM Studio endpoint: $($env:LMSTUDIO_BASE_URL ?? 'http://localhost:1234/v1')"
Write-Host "Memory bank: $($env:CHATGPT_MEMORY_BANK ?? 'C:\Users\GGPC\Desktop\chatgpt memory bank')"
