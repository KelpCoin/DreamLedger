...
async function main(){
 ...
 const required=[['DreamLedger',/DreamLedger/i],['marketplace headline',/Swipe the shelves/i],['list-price headline',/Pay the list price/i],['Live Stripe',/Live Stripe/i],['agent-readable catalog',/Agent-readable catalog/i],['billboard route',/href="\/billboard"/i],['billboard checkout route',/href="\/buy\/DREAMLEDGER-BILLBOARD-FOUNDING-001"/i],['billboard price',/NZ\$50/i]];
