...
const publicServer=path.join(ROOT,'public','server.js');
...
ok('public board route',fs.existsSync(publicServer)&&fs.readFileSync(publicServer,'utf8').includes('/billboard'),'Render public /billboard route');
