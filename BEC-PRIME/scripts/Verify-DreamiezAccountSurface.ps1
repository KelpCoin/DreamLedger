...
try{$r=Get-Text "$Base/dreamiez/login.html";Add-Check 'dreamiez login page' ($r.status -eq 200 -and $r.content -match '/api/dreamiez/account/login') ("HTTP " + $r.status)}catch{Add-Check 'dreamiez login page' $false $_.Exception.Message}
