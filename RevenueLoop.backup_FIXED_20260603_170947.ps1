...
<h2>$title</h2>
<p>Sales: $sales</p>
<a class='buy' href='$link'>Buy Now - 5.00 USD</a>
</div>
"@
}
...
<p style="margin-top:2rem;color:#555">Powered by BrownEye Cortex</p>
...
Write-Host "SAFE HTML GENERATED -> $storePath"
