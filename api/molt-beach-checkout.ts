...
form.set('payment_intent_data[metadata][product_id]',offer.sku);
form.set('payment_intent_data[metadata][product_sku]',offer.sku);
form.set('payment_intent_data[metadata][offer_id]',offer.sku);
form.set('payment_intent_data[metadata][silo]','dreamledger');
form.set('payment_intent_data[metadata][source]','molt_beach');
