...
export default async function handler(request:Request){
 ...
 const offerId=`OFFER-MOLT-BEACH-${market}-${offer.sku}`;form.set('metadata[product_sku]',offer.sku);form.set('metadata[product_id]',offer.sku);form.set('metadata[offer_id]',offerId);form.set('metadata[silo]','billboard');form.set('metadata[source]','molt-beach');form.set('payment_intent_data[metadata][product_sku]',offer.sku);form.set('payment_intent_data[metadata][product_id]',offer.sku);form.set('payment_intent_data[metadata][offer_id]',offerId);form.set('payment_intent_data[metadata][silo]','billboard');form.set('payment_intent_data[metadata][source]','molt-beach');
